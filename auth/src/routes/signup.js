...
var validate_request_1 = require("../../../common/src/middlewares/validate-request");
var user_1 = require("../models/user");
var bad_request_error_1 = require("../../../common/src/errors/bad-request-error");
...
router.post('/api/users/signup', [
    ...
    validate_request_1.validationRequest
